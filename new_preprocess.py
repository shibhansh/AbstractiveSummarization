...
for i in range(1,NumReviews_train):
    exec_str='select Text, Summary, Score from Reviews where rowid='+str(rand[i])
    ...
    # Negative samples form about 10-15% of the total. SO if there is a negative sample print it 3 times
    flag = 1 
    if Score < 3: 
        flag = 3
        negcnt += 1
